...
local function _HM_GetLang()
	...
	local t0 = LoadLUAData("H:\\JX3\\手残党国服\\Interface\\lang\\default.jx3dat") or {}
	local t1 = LoadLUAData("H:\\JX3\\手残党国服\\Interface\\lang\\" .. szLang .. ".jx3dat") or {}
...
function _HM.UI.Frm:ctor(szName, bEmpty)
	local frm, szIniFile = nil, "H:\\JX3\\手残党国服\\Interface\\ui\\WndFrame.ini"
	if bEmpty then
		szIniFile = "H:\\JX3\\手残党国服\\Interface\\ui\\WndFrameEmpty.ini"
	end
...
function _HM.UI.Wnd:ctor(pFrame, szType, szName)
	...
	if not szType and not szName then
		...
		local szFile = "H:\\JX3\\手残党国服\\Interface\\ui\\" .. szType .. ".ini"
...
function _HM.UI.Item:ctor(pHandle, szType, szName)
	...
	if not szType and not szName then
		...
		if szXml then
			...
			-- append from ini
			hnd = pHandle:AppendItemFromIni("H:\\JX3\\手残党国服\\Interface\\ui\\HandleItems.ini","Handle_" .. szType, szName)
		end
		if not hnd then
...
_HM.tSkillEx = LoadLUAData("H:\\JX3\\手残党国服\\Interface\\skill_ex.jx3dat") or {}
